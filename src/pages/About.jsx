...
function Title() {
    return (
        <div>
            <h2 className="md:text-center text-4xl md:text-5xl font-bold dark:text-neutral-200"><span className="text-blue-800">Tech Enthusiast</span> & Aspiring <span className="text-blue-800">Developer</span></h2>
        </div>
    )
}
