    ...
    return (
        <div className="w-full h-screen flex justify-center items-center px-3">
            <div className="w-full h-3/4 md:h-2/4 flex flex-row flex-wrap justify-center gap-5 md:gap-8">
                ...
                <SkillBar icon={jsIcon} alt="good level with javascript" percentaje="60%" firstBarHeight="h-2/6" secondBarHeight="h-4/6" />
                <SkillBar icon={reactIcon} alt="good level with react" percentaje="60%" firstBarHeight="h-2/6" secondBarHeight="h-4/6" />
                <SkillBar icon={tauriIcon} alt="decent level with tauri" percentaje="40%" firstBarHeight="h-4/6" secondBarHeight="h-2/6" />
                <SkillBar icon={vitejsIcon} alt="decent level with vite" percentaje="40%" firstBarHeight="h-4/6" secondBarHeight="h-2/6" />
                <SkillBar icon={pwaIcon} alt="decent level with PWAs" percentaje="40%" firstBarHeight="h-4/6" secondBarHeight="h-2/6" />
            </div>
        </div>
    );
}
...
function Title() {
    return <p className="text-2xl">I mainly make websites, but I also have experience in mobile apps, desktop apps and PWAs</p>
}
